...
namespace Facturacion.Infraestructura.Persistencia.Migrations
{
    ...
    [Migration("20260511200328_AddParametrosFacturacion")]
    partial class AddParametrosFacturacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facturacion.Core.Entidades.Empresa", b =>
                {
                    ...
                    b.Property<byte[]>("CertificadoP12")
                        .IsRequired()
                        .HasColumnType("bytea")
                        .HasColumnName("certificado_p12");
            ...
            modelBuilder.Entity("Facturacion.Core.Entidades.ParametroSri", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("parametros_sri", "facturacion");
                });
            ...
            modelBuilder.Entity("Facturacion.Core.Entidades.ParametrosFacturacion", b =>
                {
                    ...
                    b.Property<int>("NumeroDigitos")
                        .HasColumnType("integer")
                        .HasColumnName("numero_digitos");
                    ...
                    b.Property<string>("TipoIdentificadorComprador")
                        .IsRequired()
                        .HasMaxLength(2)
                        .HasColumnType("character varying(2)")
                        .HasColumnName("tipo_identificador_comprador");
