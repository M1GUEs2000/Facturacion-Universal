...
public class NotaCreditoConfiguracion : IEntityTypeConfiguration<NotaCredito>
{
    ...
    public void Configure(EntityTypeBuilder<NotaCredito> builder)
    {
        ...
        builder.Property(n => n.Ambiente).HasColumnName("ambiente").HasMaxLength(1).HasConversion(ConvertersEfCore.AmbienteConverter).IsRequired();
        ...
        builder.Property(n => n.EstadoSri).HasColumnName("estado_sri").HasMaxLength(30).HasConversion(ConvertersEfCore.EstadoSriConverter).IsRequired();
