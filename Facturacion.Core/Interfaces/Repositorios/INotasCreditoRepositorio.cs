...
public interface INotasCreditoRepositorio
{
    ...
    Task<IReadOnlyList<NotaCredito>> ListarPorEmpresaAsync(string empresaRuc, EstadoSri? estado = null, int pagina = 1, int tamanoPagina = 50, CancellationToken ct = default);
